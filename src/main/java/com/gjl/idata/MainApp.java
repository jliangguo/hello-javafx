...
public class MainApp extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        this.primaryStage.getIcons().add(new Image("/images/AddressBook.png"));
    ...
    public boolean showPersonEditDialog(Person person) {
        try {
            ...
            FXMLLoader loader = new FXMLLoader();
            AnchorPane page = (AnchorPane) loader.load(getClass().getResourceAsStream("/view/PersonEditDialog.fxml"));
            ...
            log.error("showPersonEditDialog failed. " + e);
            return false;
        }
    }
